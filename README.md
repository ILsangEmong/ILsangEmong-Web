...
SOPT 30기 솝커톤 - 무박2일 해커톤 프로젝트 4조입니다
...
|남주영|주송아|최세영|
|------|---|---|
|퍼블리싱(페이지: Result),초기세팅,라우터,api 연결|퍼블리싱(페이지: CommentForm, Expire, ResultIntro),리드미 작성,라우터 |퍼블리싱(페이지: Result, Expire, GroupMain), mock api 연결 / mock data 생성, 리드미 작성|
